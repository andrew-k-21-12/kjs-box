...
gradlePlugin {
    plugins {
        create("kjs-box-frontend-main") {
            ...
            implementationClass = "io.github.andrewk2112.kjsbox.frontend.dsl.gradle.plugins.MainModulePlugin"
        }
        create("kjs-box-frontend-entry-point") {
            id                  = "io.github.andrew-k-21-12.kjs-box.frontend-entry-point"
            implementationClass = "io.github.andrewk2112.kjsbox.frontend.dsl.gradle.plugins.EntryPointModulePlugin"
        }
        create("kjs-box-frontend-lazy-module") {
            id                  = "io.github.andrew-k-21-12.kjs-box.frontend-lazy-module"
            implementationClass = "io.github.andrewk2112.kjsbox.frontend.dsl.gradle.plugins.LazyModulePlugin"
        }
        create("kjs-box-frontend-resource-wrappers") {
            id                  = "io.github.andrew-k-21-12.kjs-box.frontend-resource-wrappers"
            implementationClass = "io.github.andrewk2112.kjsbox.frontend.dsl.gradle.plugins.ResourceWrappersGenerationPlugin"
        }
    }
}
