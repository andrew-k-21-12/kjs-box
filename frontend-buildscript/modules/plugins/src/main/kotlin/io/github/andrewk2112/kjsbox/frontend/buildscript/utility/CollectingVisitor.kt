 ...
 */
internal abstract class CollectingVisitor<T, R, E : Exception> {
     ...
     */
    internal abstract fun visit(element: T): Result<Unit, E>

    /**
     * Retrieves the overall collected data and resets the internal state.
     */
    internal fun consume(): List<R> {
     ...
     */
    protected inline fun addOrReplace(predicate: (R) -> Boolean, replacement: (R?) -> R) {
